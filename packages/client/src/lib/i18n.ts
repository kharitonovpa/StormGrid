...
const messages: Record<string, Record<string, string>> = {
  en: {
    ...
    'tutorial.move': 'Now try moving: **tap your character**, then a neighboring cell.',
  ...
  ru: {
    ...
    'tutorial.move': 'Теперь попробуй сходить: **нажми на своего персонажа**, потом на соседнюю клетку.',
