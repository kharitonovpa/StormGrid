...
export const LOOK = {
  ...
  terrain: {
    ...
    swell: {
      amp: 0.12,
      wavelength: 0.7,
      crest: 0xacc264,      // sunlit straw-green the crests lean toward
      trough: 0x2b6446,     // cool blue-green the hollows lean toward
      tint: 1.0,            // 0..1 blend toward crest/trough at full swell
    },
    /** V-groove at every cell border: depth in world units, half-width in mesh segments. */
    groove: { depth: 0.08, halfWidth: 1 },
    /** A gust's highlight on the grass (lib/sheen.ts). width/tail/speed in world units (/s). */
    sheen: { color: 0xf0d890, strength: 0.8, width: 5, tail: 5, speed: 26 },
  },
  ...
  foot: { color: 0x14122e, opacity: 0.6, across: 0.32, along: 0.62, offset: 0.15 },
