...
## Тема страницы (Edit theme)

Палитра взята из сумеречного лобби игры: небо от индиго к лиловому горизонту, малиновая кнопка Play, заголовок Comfortaa. Превью: `marketing/itch/theme/preview.png`.
...
| Text | `#e6e4ef` |
| Link | `#ff6b81` |
| Button (More options) | `#e94560` |
| Button text | `#ffffff` |
| Border | `#2c2a52` |
| Font | Comfortaa, если нет в списке, то Quicksand, иначе Nunito |
| Size | Large |
| Screenshots | Sidebar |
| Banner | `theme/banner-960x190.png`, прозрачный PNG, заменяет заголовок |
| Background | `theme/background-1920x1200.jpg`, без повтора, по центру сверху |
| Embed BG | `theme/embed-bg-960x540.jpg`, фон под кнопкой Run game |

Контраст: текст 13.6, ссылки 6.2, серый вторичный текст 7.3, белый на кнопке 3.8, этого хватает для жирного текста кнопок.
