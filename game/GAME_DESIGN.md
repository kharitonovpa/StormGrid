...
Если оба погибли в один катаклизм — ничья (draw). Ветер сам разводит обоюдный снос через тай-брейк по разбегу (§13.2), поэтому от ветра ничья возможна только при равных разбегах.
