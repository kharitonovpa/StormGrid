...
* вода перестаёт подниматься в момент его смерти, поэтому широкая низина не успевает налиться и её хозяин **выживает** — на его стороне затопление вообще не сообщается
