...
Если оба погибли в один катаклизм — ничья (draw). Обоюдный снос ветер разводит сам через тай-брейк по разбегу (§13.2), а смешанной смерти «одного сдуло, другой утонул» больше не бывает — буря обрывается на первой смерти (§12). Так что ничья остаётся возможной только в двух случаях: равные разбеги при обоюдном сносе и обоюдное утопление.
